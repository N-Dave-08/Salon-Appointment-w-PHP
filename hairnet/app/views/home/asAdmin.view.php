...
<head>
    ...
    <link rel="shortcut icon" href="<?= ROOT ?>/favicon/favicon.ico" type="image/x-icon">
    <meta charset="utf-8">
            ...
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-group input-group">
                        <input type="password" class="form-control" id="exampleInputPassword1" value="<?= get_var('password') ?>" name="password">
